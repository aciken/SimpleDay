        ...
        <View className="px-4 py-6">
          <View className="flex-row items-center mb-6">
            ...
            <View className="ml-4">
              ...
              <Text className="text-gray-500">{user?.email || 'Loading...'}</Text>
            </View>
          </View>
        </View>
        ...
        <View className="px-4">
          ...
          <View className="mb-6">
            ...
            <View className="bg-white rounded-xl border border-gray-200">
              ...
              {!isPro ? (
                <TouchableOpacity 
                  onPress={() => {router.back(); router.push('utils/Paywall')}}
                  className="flex-row items-center justify-between p-4"
                >
                  <View className="flex-row items-center">
                    <Ionicons name="card-outline" size={20} color="#666" />
                    <Text className="ml-3 text-base">Upgrade to Pro</Text>
                  </View>
            ...
            <View className="bg-white rounded-xl border border-gray-200">
              ...
              >
                <View className="flex-row items-center">
                  ...
                  <Text className="ml-3 text-base">Terms of Use</Text>
                </View>
                <Ionicons name="chevron-forward" size={20} color="#666" />
              </TouchableOpacity>
            </View>
